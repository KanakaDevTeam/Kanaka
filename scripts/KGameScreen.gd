...
func _on_BackButton_pressed():
    ...
    if get_tree().change_scene("res://scenes/KGameOverScreen.tscn") != OK:    if get_tree().change_scene("res://scenes/MainMenuScreen.tscn") != OK:
        print("Error: Unable to change the scene.")
...
func gameover():
    ...
    if get_tree().change_scene("res://scenes/KGameOverScreen.tscn") != OK:
