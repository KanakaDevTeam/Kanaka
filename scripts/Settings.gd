...
func _ready():
    ...
    tutorialbutton.togglestate = tutorialMode
    tutorialbutton.call("update_icon")
    assistbutton.togglestate = assistMode
    assistbutton.call("update_icon")
    voicerepeatbutton.togglestate = voiceRepeatControl
    voicerepeatbutton.call("update_icon")
    print("Load complete!")
